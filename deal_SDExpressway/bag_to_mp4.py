...
class RosVideoWriter(): # fps=1.0 一帧每秒
    def __init__(self, fps=1.0, rate=1.0, topic="", output_filename ="", display= False, verbose = False, start = rospy.Time(0), end = rospy.Time(sys.maxsize)):
...
# python bag_to_mp4.py 2022-11-18-23-24-13.bag